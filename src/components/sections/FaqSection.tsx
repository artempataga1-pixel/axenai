...
const faqs = [
  { q: 'Это шаблонные сайты или уникальные?', a: 'Уникальные — каждый раз с нуля. ИИ не берёт готовую тему и не перекрашивает её. Структура, текст и визуал собираются под конкретную нишу и задачу. Двух одинаковых у нас нет.' },
  ...
  { q: 'А если результат меня не устроит?', a: 'Работаем поэтапно: смотришь прогресс и говоришь что менять. Правки включены. Если к финалу не сошлись — возвращаем деньги. Пока ни разу не пришлось, но условие стоит.' },
...
export default function FaqSection() {
  ...
  return (
    <section id="faq" ref={sectionRef} className="mob-section" style={{ background: '#000', width: '100%', position: 'relative', overflow: 'hidden', padding: '7rem 1rem' }}>
        ...
        <div className="mob-full" style={{ flex: '0 0 280px', opacity: visible ? 1 : 0, transition: 'opacity 0.7s' }}>
          ...
          <div style={{ marginTop: '2rem' }}>
            ...
            <h2 style={{ fontWeight: 900, textTransform: 'uppercase', fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', color: '#fff', lineHeight: 1.15 }}>
              Главные сомнения — прямые ответы
            </h2>
          </div>
        </div>
