...
const steps = [
  { num: '01', title: 'Бриф за 10 минут', desc: 'Заполняешь форму. Ниша, стиль, что важно клиенту. Занимает меньше времени, чем объяснять всё по телефону.' },
  { num: '02', title: 'Черновик — уже на следующий день', desc: 'Не концепт-арт и не мудборд — рабочий черновик. Собираем с нуля под твою задачу. Взять шаблон и перекрасить — это к другим.' },
  { num: '03', title: 'Правишь — мы дорабатываем', desc: 'Смотришь результат. Говоришь что изменить. Вносим правки быстро — без переписки на три дня и лишних согласований.' },
  { num: '04', title: 'Готово. Всё твоё.', desc: 'Домен, хостинг, SSL — берём на себя. Полный доступ — твой. Никаких ежемесячных платежей за то, что уже оплачено.' },
];
        ...
        <div style={{
          ...
          <div style={{ flex: 1, minWidth: '260px' }}>
            ...
            <h2 style={{ fontWeight: 900, textTransform: 'uppercase', fontSize: 'clamp(1.8rem, 4vw, 3rem)', color: '#fff', lineHeight: 1.1 }}>
              Как это работает —<br />
              <span style={{ color: '#00e5ff' }}>честно</span>
            </h2>
          </div>
        </div>
